...
use App\Domains\Condo\Boundary\Output\DeleteContactResponse;
use App\Domains\Condo\Boundary\DataStructure\ContactDS;
use App\Domains\Condo\Entities\Contact;

class DeleteContactUseCase implements UseCase{
    ...
    public function execute(Request $request,$callback){
        ...
        $contact = $this->contactRepository->delete($request->id);
